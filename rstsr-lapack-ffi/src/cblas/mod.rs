...
pub const LIB_NAME: &str = "CBLAS"; // for code, e.g. "MKL"
pub const LIB_NAME_SHOW: &str = "CBLAS"; // for display, e.g. "oneMKL"
pub const LIB_NAME_LINK: &str = "blas"; // for linking, e.g. "mkl_rt"
