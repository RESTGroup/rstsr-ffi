...
KML_EXPORT int KmlIssPcStructilu0Setup(KmlIssPsStructilu0Handle *gSmoother, float *v, const int *xl, const int *xr,
    const int *yl, const int *yr, const int *zl, const int *zr);
