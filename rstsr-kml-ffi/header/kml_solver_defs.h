...
typedef enum KmlSolverParam {
    ...
    KMLSS_OFFDIAG_MATRIX_FORMAT = 23,
    KMLSS_MIN_ITERATION_COUNT = 24,
    KMLSS_ITERATION_STEP_COUNT = 25,
} KmlSolverParam;
...
typedef enum KmlSolverSorPreconditionerType {
    KMLSS_SOR_FORWARD = 0,
    KMLSS_SOR_BACKWARD = 1,
} KmlSolverSorPreconditionerType;
...
typedef enum KmlSolverMatrixFormat {
    ...
    KMLSS_COO = 3,     /* COO format */
    KMLSS_SELLCOO = 4, /* Hybrid format (sliced ELL+COO) */
