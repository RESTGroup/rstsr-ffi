...
enum KmlMpiUseSharedMemoryOption {
...
extern KML_EXPORT void KmlSetMpiUseSharedMemory(enum KmlMpiUseSharedMemoryOption);
extern KML_EXPORT enum KmlMpiUseSharedMemoryOption KmlGetMpiUseSharedMemory(void);
