...
pub const LIB_NAME: &str = "KML_LAPACK"; // for code, e.g. "MKL"
pub const LIB_NAME_SHOW: &str = "KML LAPACK (should be built to klapack_full)"; // for display, e.g. "oneMKL"
...
mod dynamic_loading_specific {
    ...
    fn check_lib_loaded(lib: &DyLoadLib) -> bool {
        lib.dsyevd_.is_some() && lib.dsygvd_.is_some()
    }
...
Condition: `dgemm_` functions must exist in the library.
