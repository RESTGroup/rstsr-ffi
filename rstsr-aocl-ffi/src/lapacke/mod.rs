...
const LIB_NAME: &str = "AOCL_FLAME"; // for code, e.g. "MKL"
const LIB_NAME_SHOW: &str = "AOCL FLAME (lapacke)"; // for display, e.g. "oneMKL"
...
Condition: functions `LAPACKE_dsyevd` must be present in the library.
