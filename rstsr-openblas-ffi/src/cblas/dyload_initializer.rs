...
impl DyLoadLib {
    pub unsafe fn new(libs: Vec<libloading::Library>, libs_path: Vec<String>) -> DyLoadLib {
        let mut result = DyLoadLib {
            ...
            openblas_set_num_threads: get_symbol(&libs, b"openblas_set_num_threads\0")
                .map(|sym| *sym),
            goto_set_num_threads: get_symbol(&libs, b"goto_set_num_threads\0").map(|sym| *sym),
            openblas_set_num_threads_local: get_symbol(&libs, b"openblas_set_num_threads_local\0")
                .map(|sym| *sym),
            openblas_get_num_threads: get_symbol(&libs, b"openblas_get_num_threads\0")
                .map(|sym| *sym),
            openblas_get_num_procs: get_symbol(&libs, b"openblas_get_num_procs\0").map(|sym| *sym),
            openblas_get_config: get_symbol(&libs, b"openblas_get_config\0").map(|sym| *sym),
            openblas_get_corename: get_symbol(&libs, b"openblas_get_corename\0").map(|sym| *sym),
            openblas_set_threads_callback_function: get_symbol(
                &libs,
            ...
            cblas_ssum: get_symbol(&libs, b"cblas_ssum\0").map(|sym| *sym),
            cblas_dsum: get_symbol(&libs, b"cblas_dsum\0").map(|sym| *sym),
            cblas_scsum: get_symbol(&libs, b"cblas_scsum\0").map(|sym| *sym),
            cblas_dzsum: get_symbol(&libs, b"cblas_dzsum\0").map(|sym| *sym),
            ...
            cblas_samax: get_symbol(&libs, b"cblas_samax\0").map(|sym| *sym),
            cblas_damax: get_symbol(&libs, b"cblas_damax\0").map(|sym| *sym),
            cblas_scamax: get_symbol(&libs, b"cblas_scamax\0").map(|sym| *sym),
            cblas_dzamax: get_symbol(&libs, b"cblas_dzamax\0").map(|sym| *sym),
            cblas_samin: get_symbol(&libs, b"cblas_samin\0").map(|sym| *sym),
            cblas_damin: get_symbol(&libs, b"cblas_damin\0").map(|sym| *sym),
            cblas_scamin: get_symbol(&libs, b"cblas_scamin\0").map(|sym| *sym),
            cblas_dzamin: get_symbol(&libs, b"cblas_dzamin\0").map(|sym| *sym),
            cblas_ismax: get_symbol(&libs, b"cblas_ismax\0").map(|sym| *sym),
            cblas_idmax: get_symbol(&libs, b"cblas_idmax\0").map(|sym| *sym),
            cblas_icmax: get_symbol(&libs, b"cblas_icmax\0").map(|sym| *sym),
            cblas_izmax: get_symbol(&libs, b"cblas_izmax\0").map(|sym| *sym),
            cblas_ismin: get_symbol(&libs, b"cblas_ismin\0").map(|sym| *sym),
            cblas_idmin: get_symbol(&libs, b"cblas_idmin\0").map(|sym| *sym),
            cblas_icmin: get_symbol(&libs, b"cblas_icmin\0").map(|sym| *sym),
            cblas_izmin: get_symbol(&libs, b"cblas_izmin\0").map(|sym| *sym),
            ...
            cblas_sgeadd: get_symbol(&libs, b"cblas_sgeadd\0").map(|sym| *sym),
            cblas_dgeadd: get_symbol(&libs, b"cblas_dgeadd\0").map(|sym| *sym),
            cblas_cgeadd: get_symbol(&libs, b"cblas_cgeadd\0").map(|sym| *sym),
            cblas_zgeadd: get_symbol(&libs, b"cblas_zgeadd\0").map(|sym| *sym),
