...
const LIB_NAME: &str = "OPENBLAS"; // for code, e.g. "MKL"
const LIB_NAME_SHOW: &str = "OpenBLAS"; // for display, e.g. "oneMKL"
const LIB_NAME_LINK: &str = "openblas"; // for linking, e.g. "mkl_rt"
