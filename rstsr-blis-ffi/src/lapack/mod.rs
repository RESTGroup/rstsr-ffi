...
const LIB_NAME: &str = "FLAME"; // for code, e.g. "MKL"
const LIB_NAME_SHOW: &str = "FLAME"; // for display, e.g. "oneMKL"
const LIB_NAME_LINK: &str = "flame"; // for linking, e.g. "mkl_rt"
...
Condition: functions `dsyevd_` must be present in the library.
