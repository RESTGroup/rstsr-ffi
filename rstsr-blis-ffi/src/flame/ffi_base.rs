...
pub const FLA_MULTITHREADING_MODEL: u32 = 0;
...
pub const PACKAGE_NAME: &[u8; 1] = b"\0";
pub const PACKAGE_STRING: &[u8; 1] = b"\0";
pub const PACKAGE_TARNAME: &[u8; 1] = b"\0";
...
pub type dim_t = c_ulong;
pub type FLA_Lock = FLA_Lock_s;
pub type FLA_RWLock = FLA_RWLock_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FLA_Lock_s {}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FLA_RWLock_s {}
