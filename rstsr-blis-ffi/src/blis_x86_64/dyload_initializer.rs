...
bli_pthread_mutex_destroy: get_symbol(&libs, b"bli_pthread_mutex_destroy\0").map(|sym| *sym),
bli_pthread_mutex_lock: get_symbol(&libs, b"bli_pthread_mutex_lock\0").map(|sym| *sym),
bli_pthread_mutex_trylock: get_symbol(&libs, b"bli_pthread_mutex_trylock\0").map(|sym| *sym),
bli_pthread_mutex_unlock: get_symbol(&libs, b"bli_pthread_mutex_unlock\0").map(|sym| *sym),
bli_pthread_cond_init: get_symbol(&libs, b"bli_pthread_cond_init\0").map(|sym| *sym),
bli_pthread_cond_destroy: get_symbol(&libs, b"bli_pthread_cond_destroy\0").map(|sym| *sym),
bli_pthread_cond_wait: get_symbol(&libs, b"bli_pthread_cond_wait\0").map(|sym| *sym),
bli_pthread_cond_broadcast: get_symbol(&libs, b"bli_pthread_cond_broadcast\0").map(|sym| *sym),
bli_pthread_once: get_symbol(&libs, b"bli_pthread_once\0").map(|sym| *sym),
bli_pthread_barrier_init: get_symbol(&libs, b"bli_pthread_barrier_init\0").map(|sym| *sym),
bli_pthread_barrier_destroy: get_symbol(&libs, b"bli_pthread_barrier_destroy\0").map(|sym| *sym),
bli_pthread_barrier_wait: get_symbol(&libs, b"bli_pthread_barrier_wait\0").map(|sym| *sym),
...
bli_cntx_init_haswell_ref: get_symbol(&libs, b"bli_cntx_init_haswell_ref\0").map(|sym| *sym),
bli_cntx_init_haswell_ind: get_symbol(&libs, b"bli_cntx_init_haswell_ind\0").map(|sym| *sym),
bli_cntx_init_sandybridge: get_symbol(&libs, b"bli_cntx_init_sandybridge\0").map(|sym| *sym),
bli_cntx_init_sandybridge_ref: get_symbol(&libs, b"bli_cntx_init_sandybridge_ref\0").map(|sym| *sym),
bli_cntx_init_sandybridge_ind: get_symbol(&libs, b"bli_cntx_init_sandybridge_ind\0").map(|sym| *sym),
bli_cntx_init_penryn: get_symbol(&libs, b"bli_cntx_init_penryn\0").map(|sym| *sym),
bli_cntx_init_penryn_ref: get_symbol(&libs, b"bli_cntx_init_penryn_ref\0").map(|sym| *sym),
bli_cntx_init_penryn_ind: get_symbol(&libs, b"bli_cntx_init_penryn_ind\0").map(|sym| *sym),
...
bli_cntx_init_excavator: get_symbol(&libs, b"bli_cntx_init_excavator\0").map(|sym| *sym),
bli_cntx_init_excavator_ref: get_symbol(&libs, b"bli_cntx_init_excavator_ref\0").map(|sym| *sym),
bli_cntx_init_excavator_ind: get_symbol(&libs, b"bli_cntx_init_excavator_ind\0").map(|sym| *sym),
bli_cntx_init_steamroller: get_symbol(&libs, b"bli_cntx_init_steamroller\0").map(|sym| *sym),
bli_cntx_init_steamroller_ref: get_symbol(&libs, b"bli_cntx_init_steamroller_ref\0").map(|sym| *sym),
bli_cntx_init_steamroller_ind: get_symbol(&libs, b"bli_cntx_init_steamroller_ind\0").map(|sym| *sym),
bli_cntx_init_piledriver: get_symbol(&libs, b"bli_cntx_init_piledriver\0").map(|sym| *sym),
bli_cntx_init_piledriver_ref: get_symbol(&libs, b"bli_cntx_init_piledriver_ref\0").map(|sym| *sym),
bli_cntx_init_piledriver_ind: get_symbol(&libs, b"bli_cntx_init_piledriver_ind\0").map(|sym| *sym),
bli_cntx_init_bulldozer: get_symbol(&libs, b"bli_cntx_init_bulldozer\0").map(|sym| *sym),
bli_cntx_init_bulldozer_ref: get_symbol(&libs, b"bli_cntx_init_bulldozer_ref\0").map(|sym| *sym),
bli_cntx_init_bulldozer_ind: get_symbol(&libs, b"bli_cntx_init_bulldozer_ind\0").map(|sym| *sym),
bli_cntx_init_generic: get_symbol(&libs, b"bli_cntx_init_generic\0").map(|sym| *sym),
bli_cntx_init_generic_ref: get_symbol(&libs, b"bli_cntx_init_generic_ref\0").map(|sym| *sym),
bli_cntx_init_generic_ind: get_symbol(&libs, b"bli_cntx_init_generic_ind\0").map(|sym| *sym),
bli_sgemm_skx_asm_32x12_l2: get_symbol(&libs, b"bli_sgemm_skx_asm_32x12_l2\0").map(|sym| *sym),
bli_sgemm_skx_asm_12x32_l2: get_symbol(&libs, b"bli_sgemm_skx_asm_12x32_l2\0").map(|sym| *sym),
bli_dgemm_skx_asm_16x12_l2: get_symbol(&libs, b"bli_dgemm_skx_asm_16x12_l2\0").map(|sym| *sym),
bli_dgemm_skx_asm_16x14: get_symbol(&libs, b"bli_dgemm_skx_asm_16x14\0").map(|sym| *sym),
bli_sgemm_knl_asm_24x16: get_symbol(&libs, b"bli_sgemm_knl_asm_24x16\0").map(|sym| *sym),
bli_dgemm_knl_asm_24x8: get_symbol(&libs, b"bli_dgemm_knl_asm_24x8\0").map(|sym| *sym),
bli_spackm_knl_asm_24x16: get_symbol(&libs, b"bli_spackm_knl_asm_24x16\0").map(|sym| *sym),
bli_dpackm_knl_asm_24x8: get_symbol(&libs, b"bli_dpackm_knl_asm_24x8\0").map(|sym| *sym),
bli_dgemm_knl_asm_12x16: get_symbol(&libs, b"bli_dgemm_knl_asm_12x16\0").map(|sym| *sym),
...
bli_dpackm_knl_asm_30x8: get_symbol(&libs, b"bli_dpackm_knl_asm_30x8\0").map(|sym| *sym),
bli_spackm_haswell_asm_6x16: get_symbol(&libs, b"bli_spackm_haswell_asm_6x16\0").map(|sym| *sym),
bli_dpackm_haswell_asm_6x8: get_symbol(&libs, b"bli_dpackm_haswell_asm_6x8\0").map(|sym| *sym),
bli_cpackm_haswell_asm_3x8: get_symbol(&libs, b"bli_cpackm_haswell_asm_3x8\0").map(|sym| *sym),
bli_zpackm_haswell_asm_3x4: get_symbol(&libs, b"bli_zpackm_haswell_asm_3x4\0").map(|sym| *sym),
bli_sgemm_haswell_asm_6x16: get_symbol(&libs, b"bli_sgemm_haswell_asm_6x16\0").map(|sym| *sym),
bli_dgemm_haswell_asm_6x8: get_symbol(&libs, b"bli_dgemm_haswell_asm_6x8\0").map(|sym| *sym),
bli_cgemm_haswell_asm_3x8: get_symbol(&libs, b"bli_cgemm_haswell_asm_3x8\0").map(|sym| *sym),
bli_zgemm_haswell_asm_3x4: get_symbol(&libs, b"bli_zgemm_haswell_asm_3x4\0").map(|sym| *sym),
bli_sgemm_haswell_asm_16x6: get_symbol(&libs, b"bli_sgemm_haswell_asm_16x6\0").map(|sym| *sym),
bli_dgemm_haswell_asm_8x6: get_symbol(&libs, b"bli_dgemm_haswell_asm_8x6\0").map(|sym| *sym),
bli_cgemm_haswell_asm_8x3: get_symbol(&libs, b"bli_cgemm_haswell_asm_8x3\0").map(|sym| *sym),
bli_zgemm_haswell_asm_4x3: get_symbol(&libs, b"bli_zgemm_haswell_asm_4x3\0").map(|sym| *sym),
bli_sgemmtrsm_l_haswell_asm_6x16: get_symbol(&libs, b"bli_sgemmtrsm_l_haswell_asm_6x16\0").map(|sym| *sym),
bli_dgemmtrsm_l_haswell_asm_6x8: get_symbol(&libs, b"bli_dgemmtrsm_l_haswell_asm_6x8\0").map(|sym| *sym),
bli_sgemmtrsm_u_haswell_asm_6x16: get_symbol(&libs, b"bli_sgemmtrsm_u_haswell_asm_6x16\0").map(|sym| *sym),
bli_dgemmtrsm_u_haswell_asm_6x8: get_symbol(&libs, b"bli_dgemmtrsm_u_haswell_asm_6x8\0").map(|sym| *sym),
bli_sgemmsup_r_haswell_ref_6x1: get_symbol(&libs, b"bli_sgemmsup_r_haswell_ref_6x1\0").map(|sym| *sym),
bli_sgemmsup_r_haswell_ref_5x1: get_symbol(&libs, b"bli_sgemmsup_r_haswell_ref_5x1\0").map(|sym| *sym),
bli_sgemmsup_r_haswell_ref_4x1: get_symbol(&libs, b"bli_sgemmsup_r_haswell_ref_4x1\0").map(|sym| *sym),
bli_sgemmsup_r_haswell_ref_3x1: get_symbol(&libs, b"bli_sgemmsup_r_haswell_ref_3x1\0").map(|sym| *sym),
bli_sgemmsup_r_haswell_ref_2x1: get_symbol(&libs, b"bli_sgemmsup_r_haswell_ref_2x1\0").map(|sym| *sym),
bli_sgemmsup_r_haswell_ref_1x1: get_symbol(&libs, b"bli_sgemmsup_r_haswell_ref_1x1\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x16: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x16\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_5x16: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_5x16\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_4x16: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_4x16\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_3x16: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_3x16\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_2x16: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_2x16\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_1x16: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_1x16\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x12: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x12\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_5x12: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_5x12\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_4x12: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_4x12\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_3x12: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_3x12\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_2x12: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_2x12\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_1x12: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_1x12\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x8: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x8\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_5x8: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_5x8\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_4x8: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_4x8\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_3x8: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_3x8\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_2x8: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_2x8\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_1x8: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_1x8\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x6: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x6\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_5x6: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_5x6\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_4x6: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_4x6\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_3x6: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_3x6\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_2x6: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_2x6\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_1x6: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_1x6\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x4: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x4\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_5x4: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_5x4\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_4x4: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_4x4\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_3x4: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_3x4\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_2x4: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_2x4\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_1x4: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_1x4\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x2: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x2\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_5x2: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_5x2\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_4x2: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_4x2\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_3x2: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_3x2\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_2x2: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_2x2\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_1x2: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_1x2\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x16m: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x16m\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x12m: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x12m\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x8m: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x8m\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x6m: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x6m\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x4m: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x4m\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x2m: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x2m\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_6x16n: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_6x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_5x16n: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_5x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_4x16n: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_4x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_3x16n: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_3x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_2x16n: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_2x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_haswell_asm_1x16n: get_symbol(&libs, b"bli_sgemmsup_rv_haswell_asm_1x16n\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x16: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x16\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_2x16: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_2x16\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_1x16: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_1x16\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x12: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x12\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_2x12: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_2x12\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_1x12: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_1x12\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x8: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x8\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_2x8: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_2x8\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_1x8: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_1x8\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x4: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x4\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_2x4: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_2x4\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_1x4: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_1x4\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x2: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x2\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_3x2: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_3x2\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_2x2: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_2x2\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_1x2: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_1x2\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x1: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x1\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_3x1: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_3x1\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_2x1: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_2x1\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_1x1: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_1x1\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x16m: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x16m\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x12m: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x12m\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x8m: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x8m\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x4m: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x4m\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x2m: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x2m\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_6x16n: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_6x16n\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_3x16n: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_3x16n\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_2x16n: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_2x16n\0").map(|sym| *sym),
bli_sgemmsup_rd_haswell_asm_1x16n: get_symbol(&libs, b"bli_sgemmsup_rd_haswell_asm_1x16n\0").map(|sym| *sym),
bli_dgemmsup_r_haswell_ref_6x1: get_symbol(&libs, b"bli_dgemmsup_r_haswell_ref_6x1\0").map(|sym| *sym),
bli_dgemmsup_r_haswell_ref_5x1: get_symbol(&libs, b"bli_dgemmsup_r_haswell_ref_5x1\0").map(|sym| *sym),
bli_dgemmsup_r_haswell_ref_4x1: get_symbol(&libs, b"bli_dgemmsup_r_haswell_ref_4x1\0").map(|sym| *sym),
bli_dgemmsup_r_haswell_ref_3x1: get_symbol(&libs, b"bli_dgemmsup_r_haswell_ref_3x1\0").map(|sym| *sym),
bli_dgemmsup_r_haswell_ref_2x1: get_symbol(&libs, b"bli_dgemmsup_r_haswell_ref_2x1\0").map(|sym| *sym),
bli_dgemmsup_r_haswell_ref_1x1: get_symbol(&libs, b"bli_dgemmsup_r_haswell_ref_1x1\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x8: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x8\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_5x8: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_5x8\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_4x8: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_4x8\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_3x8: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_3x8\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_2x8: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_2x8\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_1x8: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_1x8\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x6: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x6\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_5x6: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_5x6\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_4x6: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_4x6\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_3x6: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_3x6\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_2x6: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_2x6\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_1x6: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_1x6\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x4: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x4\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_5x4: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_5x4\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_4x4: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_4x4\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_3x4: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_3x4\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_2x4: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_2x4\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_1x4: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_1x4\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x2: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x2\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_5x2: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_5x2\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_4x2: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_4x2\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_3x2: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_3x2\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_2x2: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_2x2\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_1x2: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_1x2\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x8m: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x8m\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x6m: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x6m\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x4m: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x4m\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x2m: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x2m\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_6x8n: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_6x8n\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_5x8n: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_5x8n\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_4x8n: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_4x8n\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_3x8n: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_3x8n\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_2x8n: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_2x8n\0").map(|sym| *sym),
bli_dgemmsup_rv_haswell_asm_1x8n: get_symbol(&libs, b"bli_dgemmsup_rv_haswell_asm_1x8n\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_6x8: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_6x8\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_2x8: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_2x8\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_1x8: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_1x8\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_6x4: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_6x4\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_2x4: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_2x4\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_1x4: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_1x4\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_6x2: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_6x2\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_3x2: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_3x2\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_2x2: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_2x2\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_1x2: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_1x2\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_6x1: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_6x1\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_3x1: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_3x1\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_2x1: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_2x1\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_1x1: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_1x1\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_6x8m: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_6x8m\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_6x4m: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_6x4m\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_6x2m: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_6x2m\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_6x8n: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_6x8n\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_3x8n: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_3x8n\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_2x8n: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_2x8n\0").map(|sym| *sym),
bli_dgemmsup_rd_haswell_asm_1x8n: get_symbol(&libs, b"bli_dgemmsup_rd_haswell_asm_1x8n\0").map(|sym| *sym),
bli_sgemm_sandybridge_asm_8x8: get_symbol(&libs, b"bli_sgemm_sandybridge_asm_8x8\0").map(|sym| *sym),
bli_dgemm_sandybridge_asm_8x4: get_symbol(&libs, b"bli_dgemm_sandybridge_asm_8x4\0").map(|sym| *sym),
bli_cgemm_sandybridge_asm_8x4: get_symbol(&libs, b"bli_cgemm_sandybridge_asm_8x4\0").map(|sym| *sym),
bli_zgemm_sandybridge_asm_4x4: get_symbol(&libs, b"bli_zgemm_sandybridge_asm_4x4\0").map(|sym| *sym),
bli_sgemm_sandybridge_int_8x8: get_symbol(&libs, b"bli_sgemm_sandybridge_int_8x8\0").map(|sym| *sym),
bli_dgemm_sandybridge_int_8x4: get_symbol(&libs, b"bli_dgemm_sandybridge_int_8x4\0").map(|sym| *sym),
bli_cgemm_sandybridge_int_8x4: get_symbol(&libs, b"bli_cgemm_sandybridge_int_8x4\0").map(|sym| *sym),
bli_zgemm_sandybridge_int_4x4: get_symbol(&libs, b"bli_zgemm_sandybridge_int_4x4\0").map(|sym| *sym),
bli_sgemm_penryn_asm_8x4: get_symbol(&libs, b"bli_sgemm_penryn_asm_8x4\0").map(|sym| *sym),
bli_dgemm_penryn_asm_4x4: get_symbol(&libs, b"bli_dgemm_penryn_asm_4x4\0").map(|sym| *sym),
bli_dgemmtrsm_l_penryn_asm_4x4: get_symbol(&libs, b"bli_dgemmtrsm_l_penryn_asm_4x4\0").map(|sym| *sym),
bli_dgemmtrsm_u_penryn_asm_4x4: get_symbol(&libs, b"bli_dgemmtrsm_u_penryn_asm_4x4\0").map(|sym| *sym),
bli_dtrsm_l_penryn_asm_4x4: get_symbol(&libs, b"bli_dtrsm_l_penryn_asm_4x4\0").map(|sym| *sym),
bli_dtrsm_u_penryn_asm_4x4: get_symbol(&libs, b"bli_dtrsm_u_penryn_asm_4x4\0").map(|sym| *sym),
...
bli_daxpyf_zen_int_16x4: get_symbol(&libs, b"bli_daxpyf_zen_int_16x4\0").map(|sym| *sym),
...
bli_sgemmsup_rv_zen_asm_5x16: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_5x16\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_4x16: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_4x16\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_3x16: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_3x16\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_2x16: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_2x16\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_1x16: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_1x16\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_6x8: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_6x8\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_5x8: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_5x8\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_4x8: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_4x8\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_3x8: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_3x8\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_2x8: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_2x8\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_1x8: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_1x8\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_6x4: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_6x4\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_5x4: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_5x4\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_4x4: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_4x4\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_3x4: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_3x4\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_2x4: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_2x4\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_1x4: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_1x4\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_6x2: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_6x2\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_5x2: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_5x2\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_4x2: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_4x2\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_3x2: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_3x2\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_2x2: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_2x2\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_1x2: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_1x2\0").map(|sym| *sym),
bli_sgemmsup_r_zen_ref_6x1: get_symbol(&libs, b"bli_sgemmsup_r_zen_ref_6x1\0").map(|sym| *sym),
bli_sgemmsup_r_zen_ref_5x1: get_symbol(&libs, b"bli_sgemmsup_r_zen_ref_5x1\0").map(|sym| *sym),
bli_sgemmsup_r_zen_ref_4x1: get_symbol(&libs, b"bli_sgemmsup_r_zen_ref_4x1\0").map(|sym| *sym),
bli_sgemmsup_r_zen_ref_3x1: get_symbol(&libs, b"bli_sgemmsup_r_zen_ref_3x1\0").map(|sym| *sym),
bli_sgemmsup_r_zen_ref_2x1: get_symbol(&libs, b"bli_sgemmsup_r_zen_ref_2x1\0").map(|sym| *sym),
bli_sgemmsup_r_zen_ref_1x1: get_symbol(&libs, b"bli_sgemmsup_r_zen_ref_1x1\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_6x16m: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_6x16m\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_6x8m: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_6x8m\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_6x4m: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_6x4m\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_6x2m: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_6x2m\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_6x16n: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_6x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_5x16n: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_5x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_4x16n: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_4x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_3x16n: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_3x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_2x16n: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_2x16n\0").map(|sym| *sym),
bli_sgemmsup_rv_zen_asm_1x16n: get_symbol(&libs, b"bli_sgemmsup_rv_zen_asm_1x16n\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_2x8: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_2x8\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_2x16: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_2x16\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_1x8: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_1x8\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_1x16: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_1x16\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_6x4: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_6x4\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_2x4: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_2x4\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_1x4: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_1x4\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_6x2: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_6x2\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_3x2: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_3x2\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_2x2: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_2x2\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_1x2: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_1x2\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_6x16m: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_6x16m\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_6x8m: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_6x8m\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_6x4m: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_6x4m\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_6x2m: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_6x2m\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_6x16n: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_6x16n\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_3x16n: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_3x16n\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_2x16n: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_2x16n\0").map(|sym| *sym),
bli_sgemmsup_rd_zen_asm_1x16n: get_symbol(&libs, b"bli_sgemmsup_rd_zen_asm_1x16n\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_3x8m: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_3x8m\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_3x4m: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_3x4m\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_3x2m: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_3x2m\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_2x8: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_2x8\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_1x8: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_1x8\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_2x4: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_2x4\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_1x4: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_1x4\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_2x2: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_2x2\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_1x2: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_1x2\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_3x4m: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_3x4m\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_3x2m: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_3x2m\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_2x4: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_2x4\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_1x4: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_1x4\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_2x2: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_2x2\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_1x2: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_1x2\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_3x8n: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_3x8n\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_2x8n: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_2x8n\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_1x8n: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_1x8n\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_3x4: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_3x4\0").map(|sym| *sym),
bli_cgemmsup_rv_zen_asm_3x2: get_symbol(&libs, b"bli_cgemmsup_rv_zen_asm_3x2\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_3x4n: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_3x4n\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_2x4n: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_2x4n\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_1x4n: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_1x4n\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_3x2: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_3x2\0").map(|sym| *sym),
bli_zgemmsup_rv_zen_asm_3x1: get_symbol(&libs, b"bli_zgemmsup_rv_zen_asm_3x1\0").map(|sym| *sym),
bli_sgemm_piledriver_asm_16x3: get_symbol(&libs, b"bli_sgemm_piledriver_asm_16x3\0").map(|sym| *sym),
bli_dgemm_piledriver_asm_8x3: get_symbol(&libs, b"bli_dgemm_piledriver_asm_8x3\0").map(|sym| *sym),
bli_cgemm_piledriver_asm_4x2: get_symbol(&libs, b"bli_cgemm_piledriver_asm_4x2\0").map(|sym| *sym),
bli_zgemm_piledriver_asm_2x2: get_symbol(&libs, b"bli_zgemm_piledriver_asm_2x2\0").map(|sym| *sym),
bli_sgemm_bulldozer_asm_8x8_fma4: get_symbol(&libs, b"bli_sgemm_bulldozer_asm_8x8_fma4\0").map(|sym| *sym),
bli_dgemm_bulldozer_asm_4x6_fma4: get_symbol(&libs, b"bli_dgemm_bulldozer_asm_4x6_fma4\0").map(|sym| *sym),
bli_cgemm_bulldozer_asm_8x4_fma4: get_symbol(&libs, b"bli_cgemm_bulldozer_asm_8x4_fma4\0").map(|sym| *sym),
bli_zgemm_bulldozer_asm_4x4_fma4: get_symbol(&libs, b"bli_zgemm_bulldozer_asm_4x4_fma4\0").map(|sym| *sym),
bli_thrcomm_init_single: get_symbol(&libs, b"bli_thrcomm_init_single\0").map(|sym| *sym),
bli_thrcomm_cleanup_single: get_symbol(&libs, b"bli_thrcomm_cleanup_single\0").map(|sym| *sym),
bli_thrcomm_barrier_single: get_symbol(&libs, b"bli_thrcomm_barrier_single\0").map(|sym| *sym),
bli_thrcomm_init_openmp: get_symbol(&libs, b"bli_thrcomm_init_openmp\0").map(|sym| *sym),
bli_thrcomm_cleanup_openmp: get_symbol(&libs, b"bli_thrcomm_cleanup_openmp\0").map(|sym| *sym),
bli_thrcomm_barrier_openmp: get_symbol(&libs, b"bli_thrcomm_barrier_openmp\0").map(|sym| *sym),
bli_thrcomm_init_pthreads: get_symbol(&libs, b"bli_thrcomm_init_pthreads\0").map(|sym| *sym),
bli_thrcomm_cleanup_pthreads: get_symbol(&libs, b"bli_thrcomm_cleanup_pthreads\0").map(|sym| *sym),
bli_thrcomm_barrier_pthreads: get_symbol(&libs, b"bli_thrcomm_barrier_pthreads\0").map(|sym| *sym),
...
bli_thrcomm_barrier_atomic: get_symbol(&libs, b"bli_thrcomm_barrier_atomic\0").map(|sym| *sym),
bli_thrinfo_attach_sub_node: get_symbol(&libs, b"bli_thrinfo_attach_sub_node\0").map(|sym| *sym),
bli_thrinfo_create_root: get_symbol(&libs, b"bli_thrinfo_create_root\0").map(|sym| *sym),
...
bli_thread_launch_openmp: get_symbol(&libs, b"bli_thread_launch_openmp\0").map(|sym| *sym),
bli_thread_launch_pthreads: get_symbol(&libs, b"bli_thread_launch_pthreads\0").map(|sym| *sym),
bli_thread_launch_single: get_symbol(&libs, b"bli_thread_launch_single\0").map(|sym| *sym),
...
bli_prime_factorization: get_symbol(&libs, b"bli_prime_factorization\0").map(|sym| *sym),
...
bli_thread_partition_2x2: get_symbol(&libs, b"bli_thread_partition_2x2\0").map(|sym| *sym),
bli_thread_partition_2x2_slow: get_symbol(&libs, b"bli_thread_partition_2x2_slow\0").map(|sym| *sym),
bli_thread_partition_2x2_fast: get_symbol(&libs, b"bli_thread_partition_2x2_fast\0").map(|sym| *sym),
...
bli_thread_get_num_threads: get_symbol(&libs, b"bli_thread_get_num_threads\0").map(|sym| *sym),
bli_thread_get_thread_impl: get_symbol(&libs, b"bli_thread_get_thread_impl\0").map(|sym| *sym),
bli_thread_get_thread_impl_str: get_symbol(&libs, b"bli_thread_get_thread_impl_str\0").map(|sym| *sym),
bli_thread_set_ways: get_symbol(&libs, b"bli_thread_set_ways\0").map(|sym| *sym),
bli_thread_set_num_threads: get_symbol(&libs, b"bli_thread_set_num_threads\0").map(|sym| *sym),
bli_thread_set_thread_impl: get_symbol(&libs, b"bli_thread_set_thread_impl\0").map(|sym| *sym),
...
bli_thread_range_width_l: get_symbol(&libs, b"bli_thread_range_width_l\0").map(|sym| *sym),
bli_find_area_trap_l: get_symbol(&libs, b"bli_find_area_trap_l\0").map(|sym| *sym),
bli_thread_range_weighted_sub: get_symbol(&libs, b"bli_thread_range_weighted_sub\0").map(|sym| *sym),
...
bli_thread_range_tlb_trmm_ll: get_symbol(&libs, b"bli_thread_range_tlb_trmm_ll\0").map(|sym| *sym),
bli_thread_range_tlb_trmm_lu: get_symbol(&libs, b"bli_thread_range_tlb_trmm_lu\0").map(|sym| *sym),
bli_thread_range_tlb_trmm_lx_impl: get_symbol(&libs, b"bli_thread_range_tlb_trmm_lx_impl\0").map(|sym| *sym),
bli_thread_range_tlb_trmm_rl: get_symbol(&libs, b"bli_thread_range_tlb_trmm_rl\0").map(|sym| *sym),
bli_thread_range_tlb_trmm_ru: get_symbol(&libs, b"bli_thread_range_tlb_trmm_ru\0").map(|sym| *sym),
bli_thread_range_tlb_trmm_rl_impl: get_symbol(&libs, b"bli_thread_range_tlb_trmm_rl_impl\0").map(|sym| *sym),
...
bli_fmalloc_align_check: get_symbol(&libs, b"bli_fmalloc_align_check\0").map(|sym| *sym),
...
bli_obj_create_without_buffer_check: get_symbol(&libs, b"bli_obj_create_without_buffer_check\0").map(|sym| *sym),
bli_obj_alloc_buffer_check: get_symbol(&libs, b"bli_obj_alloc_buffer_check\0").map(|sym| *sym),
bli_obj_attach_buffer_check: get_symbol(&libs, b"bli_obj_attach_buffer_check\0").map(|sym| *sym),
bli_obj_create_scalar_check: get_symbol(&libs, b"bli_obj_create_scalar_check\0").map(|sym| *sym),
bli_obj_free_check: get_symbol(&libs, b"bli_obj_free_check\0").map(|sym| *sym),
bli_obj_create_const_check: get_symbol(&libs, b"bli_obj_create_const_check\0").map(|sym| *sym),
bli_obj_create_const_copy_of_check: get_symbol(&libs, b"bli_obj_create_const_copy_of_check\0").map(|sym| *sym),
...
bli_obj_create_with_attached_buffer: get_symbol(&libs, b"bli_obj_create_with_attached_buffer\0").map(|sym| *sym),
bli_obj_create_without_buffer: get_symbol(&libs, b"bli_obj_create_without_buffer\0").map(|sym| *sym),
...
bli_obj_create_1x1_with_attached_buffer: get_symbol(&libs, b"bli_obj_create_1x1_with_attached_buffer\0").map(|sym| *sym),
...
bli_obj_scalar_init_detached: get_symbol(&libs, b"bli_obj_scalar_init_detached\0").map(|sym| *sym),
bli_obj_scalar_init_detached_copy_of: get_symbol(&libs, b"bli_obj_scalar_init_detached_copy_of\0").map(|sym| *sym),
...
bli_obj_scalar_apply_scalar: get_symbol(&libs, b"bli_obj_scalar_apply_scalar\0").map(|sym| *sym),
bli_obj_scalar_reset: get_symbol(&libs, b"bli_obj_scalar_reset\0").map(|sym| *sym),
bli_obj_scalar_has_nonzero_imag: get_symbol(&libs, b"bli_obj_scalar_has_nonzero_imag\0").map(|sym| *sym),
...
bli_blksz_reduce_def_to: get_symbol(&libs, b"bli_blksz_reduce_def_to\0").map(|sym| *sym),
bli_blksz_reduce_max_to: get_symbol(&libs, b"bli_blksz_reduce_max_to\0").map(|sym| *sym),
bli_determine_blocksize: get_symbol(&libs, b"bli_determine_blocksize\0").map(|sym| *sym),
...
bli_check_error_code_helper: get_symbol(&libs, b"bli_check_error_code_helper\0").map(|sym| *sym),
bli_check_valid_error_level: get_symbol(&libs, b"bli_check_valid_error_level\0").map(|sym| *sym),
...
bli_check_valid_datatype: get_symbol(&libs, b"bli_check_valid_datatype\0").map(|sym| *sym),
bli_check_object_valid_datatype: get_symbol(&libs, b"bli_check_object_valid_datatype\0").map(|sym| *sym),
bli_check_noninteger_datatype: get_symbol(&libs, b"bli_check_noninteger_datatype\0").map(|sym| *sym),
bli_check_noninteger_object: get_symbol(&libs, b"bli_check_noninteger_object\0").map(|sym| *sym),
bli_check_nonconstant_datatype: get_symbol(&libs, b"bli_check_nonconstant_datatype\0").map(|sym| *sym),
bli_check_nonconstant_object: get_symbol(&libs, b"bli_check_nonconstant_object\0").map(|sym| *sym),
bli_check_floating_datatype: get_symbol(&libs, b"bli_check_floating_datatype\0").map(|sym| *sym),
bli_check_floating_object: get_symbol(&libs, b"bli_check_floating_object\0").map(|sym| *sym),
bli_check_real_datatype: get_symbol(&libs, b"bli_check_real_datatype\0").map(|sym| *sym),
bli_check_real_object: get_symbol(&libs, b"bli_check_real_object\0").map(|sym| *sym),
bli_check_integer_datatype: get_symbol(&libs, b"bli_check_integer_datatype\0").map(|sym| *sym),
bli_check_integer_object: get_symbol(&libs, b"bli_check_integer_object\0").map(|sym| *sym),
bli_check_consistent_datatypes: get_symbol(&libs, b"bli_check_consistent_datatypes\0").map(|sym| *sym),
bli_check_consistent_object_datatypes: get_symbol(&libs, b"bli_check_consistent_object_datatypes\0").map(|sym| *sym),
bli_check_datatype_real_proj_of: get_symbol(&libs, b"bli_check_datatype_real_proj_of\0").map(|sym| *sym),
bli_check_object_real_proj_of: get_symbol(&libs, b"bli_check_object_real_proj_of\0").map(|sym| *sym),
bli_check_real_valued_object: get_symbol(&libs, b"bli_check_real_valued_object\0").map(|sym| *sym),
bli_check_consistent_precisions: get_symbol(&libs, b"bli_check_consistent_precisions\0").map(|sym| *sym),
bli_check_consistent_object_precisions: get_symbol(&libs, b"bli_check_consistent_object_precisions\0").map(|sym| *sym),
bli_check_conformal_dims: get_symbol(&libs, b"bli_check_conformal_dims\0").map(|sym| *sym),
bli_check_level3_dims: get_symbol(&libs, b"bli_check_level3_dims\0").map(|sym| *sym),
bli_check_scalar_object: get_symbol(&libs, b"bli_check_scalar_object\0").map(|sym| *sym),
bli_check_vector_object: get_symbol(&libs, b"bli_check_vector_object\0").map(|sym| *sym),
bli_check_matrix_object: get_symbol(&libs, b"bli_check_matrix_object\0").map(|sym| *sym),
bli_check_equal_vector_lengths: get_symbol(&libs, b"bli_check_equal_vector_lengths\0").map(|sym| *sym),
bli_check_square_object: get_symbol(&libs, b"bli_check_square_object\0").map(|sym| *sym),
bli_check_object_length_equals: get_symbol(&libs, b"bli_check_object_length_equals\0").map(|sym| *sym),
bli_check_object_width_equals: get_symbol(&libs, b"bli_check_object_width_equals\0").map(|sym| *sym),
bli_check_vector_dim_equals: get_symbol(&libs, b"bli_check_vector_dim_equals\0").map(|sym| *sym),
bli_check_object_diag_offset_equals: get_symbol(&libs, b"bli_check_object_diag_offset_equals\0").map(|sym| *sym),
bli_check_matrix_strides: get_symbol(&libs, b"bli_check_matrix_strides\0").map(|sym| *sym),
bli_check_general_object: get_symbol(&libs, b"bli_check_general_object\0").map(|sym| *sym),
bli_check_hermitian_object: get_symbol(&libs, b"bli_check_hermitian_object\0").map(|sym| *sym),
bli_check_symmetric_object: get_symbol(&libs, b"bli_check_symmetric_object\0").map(|sym| *sym),
bli_check_triangular_object: get_symbol(&libs, b"bli_check_triangular_object\0").map(|sym| *sym),
bli_check_object_struc: get_symbol(&libs, b"bli_check_object_struc\0").map(|sym| *sym),
bli_check_upper_or_lower_object: get_symbol(&libs, b"bli_check_upper_or_lower_object\0").map(|sym| *sym),
bli_check_valid_3x1_subpart: get_symbol(&libs, b"bli_check_valid_3x1_subpart\0").map(|sym| *sym),
bli_check_valid_1x3_subpart: get_symbol(&libs, b"bli_check_valid_1x3_subpart\0").map(|sym| *sym),
bli_check_valid_3x3_subpart: get_symbol(&libs, b"bli_check_valid_3x3_subpart\0").map(|sym| *sym),
bli_check_valid_cntl: get_symbol(&libs, b"bli_check_valid_cntl\0").map(|sym| *sym),
bli_check_packm_schema_on_unpack: get_symbol(&libs, b"bli_check_packm_schema_on_unpack\0").map(|sym| *sym),
bli_check_packv_schema_on_unpack: get_symbol(&libs, b"bli_check_packv_schema_on_unpack\0").map(|sym| *sym),
bli_check_object_buffer: get_symbol(&libs, b"bli_check_object_buffer\0").map(|sym| *sym),
bli_check_valid_malloc_buf: get_symbol(&libs, b"bli_check_valid_malloc_buf\0").map(|sym| *sym),
bli_check_valid_packbuf: get_symbol(&libs, b"bli_check_valid_packbuf\0").map(|sym| *sym),
bli_check_if_exhausted_pool: get_symbol(&libs, b"bli_check_if_exhausted_pool\0").map(|sym| *sym),
bli_check_sufficient_stack_buf_size: get_symbol(&libs, b"bli_check_sufficient_stack_buf_size\0").map(|sym| *sym),
bli_check_alignment_is_power_of_two: get_symbol(&libs, b"bli_check_alignment_is_power_of_two\0").map(|sym| *sym),
bli_check_alignment_is_mult_of_ptr_size: get_symbol(&libs, b"bli_check_alignment_is_mult_of_ptr_size\0").map(|sym| *sym),
bli_check_object_alias_of: get_symbol(&libs, b"bli_check_object_alias_of\0").map(|sym| *sym),
bli_check_valid_arch_id: get_symbol(&libs, b"bli_check_valid_arch_id\0").map(|sym| *sym),
bli_check_initialized_gks_cntx: get_symbol(&libs, b"bli_check_initialized_gks_cntx\0").map(|sym| *sym),
bli_check_valid_mc_mod_mult: get_symbol(&libs, b"bli_check_valid_mc_mod_mult\0").map(|sym| *sym),
bli_check_valid_nc_mod_mult: get_symbol(&libs, b"bli_check_valid_nc_mod_mult\0").map(|sym| *sym),
bli_check_valid_kc_mod_mult: get_symbol(&libs, b"bli_check_valid_kc_mod_mult\0").map(|sym| *sym),
bli_check_valid_mr_even: get_symbol(&libs, b"bli_check_valid_mr_even\0").map(|sym| *sym),
bli_check_valid_nr_even: get_symbol(&libs, b"bli_check_valid_nr_even\0").map(|sym| *sym),
...
bli_cntx_set_l3_sup_handlers: get_symbol(&libs, b"bli_cntx_set_l3_sup_handlers\0").map(|sym| *sym),
bli_cntx_register_blksz: get_symbol(&libs, b"bli_cntx_register_blksz\0").map(|sym| *sym),
...
bli_cntx_register_ukr_pref: get_symbol(&libs, b"bli_cntx_register_ukr_pref\0").map(|sym| *sym),
bli_global_rntm: get_symbol(&libs, b"bli_global_rntm\0").map(|sym| *sym),
bli_global_rntm_at_init: get_symbol(&libs, b"bli_global_rntm_at_init\0").map(|sym| *sym),
...
bli_rntm_init_from_global: get_symbol(&libs, b"bli_rntm_init_from_global\0").map(|sym| *sym),
bli_rntm_set_num_threads: get_symbol(&libs, b"bli_rntm_set_num_threads\0").map(|sym| *sym),
...
bli_rntm_calc_num_threads_in: get_symbol(&libs, b"bli_rntm_calc_num_threads_in\0").map(|sym| *sym),
...
bli_gks_query_cntx_noinit: get_symbol(&libs, b"bli_gks_query_cntx_noinit\0").map(|sym| *sym),
bli_gks_query_cntx_impl: get_symbol(&libs, b"bli_gks_query_cntx_impl\0").map(|sym| *sym),
bli_gks_init_ref_cntx: get_symbol(&libs, b"bli_gks_init_ref_cntx\0").map(|sym| *sym),
bli_gks_cntx_ukr_is_ref: get_symbol(&libs, b"bli_gks_cntx_ukr_is_ref\0").map(|sym| *sym),
bli_gks_cntx_ukr2_is_ref: get_symbol(&libs, b"bli_gks_cntx_ukr2_is_ref\0").map(|sym| *sym),
bli_gks_l3_ukr_impl_string: get_symbol(&libs, b"bli_gks_l3_ukr_impl_string\0").map(|sym| *sym),
bli_gks_l3_ukr_impl_type: get_symbol(&libs, b"bli_gks_l3_ukr_impl_type\0").map(|sym| *sym),
...
bli_gks_register_ukr_pref: get_symbol(&libs, b"bli_gks_register_ukr_pref\0").map(|sym| *sym),
bli_gemmind_find_avail: get_symbol(&libs, b"bli_gemmind_find_avail\0").map(|sym| *sym),
bli_gemmtind_find_avail: get_symbol(&libs, b"bli_gemmtind_find_avail\0").map(|sym| *sym),
...
bli_trmm3ind_find_avail: get_symbol(&libs, b"bli_trmm3ind_find_avail\0").map(|sym| *sym),
...
bli_l3_ind_oper_find_avail: get_symbol(&libs, b"bli_l3_ind_oper_find_avail\0").map(|sym| *sym),
bli_l3_ind_set_enable_dt: get_symbol(&libs, b"bli_l3_ind_set_enable_dt\0").map(|sym| *sym),
bli_l3_ind_oper_enable_only: get_symbol(&libs, b"bli_l3_ind_oper_enable_only\0").map(|sym| *sym),
bli_l3_ind_oper_set_enable_all: get_symbol(&libs, b"bli_l3_ind_oper_set_enable_all\0").map(|sym| *sym),
bli_l3_ind_oper_set_enable: get_symbol(&libs, b"bli_l3_ind_oper_set_enable\0").map(|sym| *sym),
bli_l3_ind_oper_get_enable: get_symbol(&libs, b"bli_l3_ind_oper_get_enable\0").map(|sym| *sym),
bli_l3_ind_oper_is_impl: get_symbol(&libs, b"bli_l3_ind_oper_is_impl\0").map(|sym| *sym),
...
bli_ind_oper_enable_only: get_symbol(&libs, b"bli_ind_oper_enable_only\0").map(|sym| *sym),
bli_ind_oper_is_impl: get_symbol(&libs, b"bli_ind_oper_is_impl\0").map(|sym| *sym),
bli_ind_oper_find_avail: get_symbol(&libs, b"bli_ind_oper_find_avail\0").map(|sym| *sym),
bli_ind_oper_get_avail_impl_string: get_symbol(&libs, b"bli_ind_oper_get_avail_impl_string\0").map(|sym| *sym),
bli_ind_get_impl_string: get_symbol(&libs, b"bli_ind_get_impl_string\0").map(|sym| *sym),
bli_ind_map_cdt_to_index: get_symbol(&libs, b"bli_ind_map_cdt_to_index\0").map(|sym| *sym),
...
bli_pba_compute_pool_block_sizes: get_symbol(&libs, b"bli_pba_compute_pool_block_sizes\0").map(|sym| *sym),
bli_pba_compute_pool_block_sizes_dt: get_symbol(&libs, b"bli_pba_compute_pool_block_sizes_dt\0").map(|sym| *sym),
...
bli_pool_checkout_block: get_symbol(&libs, b"bli_pool_checkout_block\0").map(|sym| *sym),
...
bli_apool_checkout_array: get_symbol(&libs, b"bli_apool_checkout_array\0").map(|sym| *sym),
bli_apool_checkin_array: get_symbol(&libs, b"bli_apool_checkin_array\0").map(|sym| *sym),
...
bli_acquire_mpart_t2b_check: get_symbol(&libs, b"bli_acquire_mpart_t2b_check\0").map(|sym| *sym),
bli_acquire_mpart_l2r_check: get_symbol(&libs, b"bli_acquire_mpart_l2r_check\0").map(|sym| *sym),
bli_acquire_mpart_tl2br_check: get_symbol(&libs, b"bli_acquire_mpart_tl2br_check\0").map(|sym| *sym),
...
bli_acquire_mpart_tl2br: get_symbol(&libs, b"bli_acquire_mpart_tl2br\0").map(|sym| *sym),
bli_acquire_mpart_br2tl: get_symbol(&libs, b"bli_acquire_mpart_br2tl\0").map(|sym| *sym),
...
bli_acquire_mpart_mndim: get_symbol(&libs, b"bli_acquire_mpart_mndim\0").map(|sym| *sym),
...
bli_part_cntl_init_node: get_symbol(&libs, b"bli_part_cntl_init_node\0").map(|sym| *sym),
...
bli_param_map_blis_to_netlib_side: get_symbol(&libs, b"bli_param_map_blis_to_netlib_side\0").map(|sym| *sym),
bli_param_map_blis_to_netlib_uplo: get_symbol(&libs, b"bli_param_map_blis_to_netlib_uplo\0").map(|sym| *sym),
bli_param_map_blis_to_netlib_trans: get_symbol(&libs, b"bli_param_map_blis_to_netlib_trans\0").map(|sym| *sym),
bli_param_map_blis_to_netlib_diag: get_symbol(&libs, b"bli_param_map_blis_to_netlib_diag\0").map(|sym| *sym),
bli_param_map_blis_to_netlib_machval: get_symbol(&libs, b"bli_param_map_blis_to_netlib_machval\0").map(|sym| *sym),
bli_param_map_char_to_blis_side: get_symbol(&libs, b"bli_param_map_char_to_blis_side\0").map(|sym| *sym),
bli_param_map_char_to_blis_uplo: get_symbol(&libs, b"bli_param_map_char_to_blis_uplo\0").map(|sym| *sym),
bli_param_map_char_to_blis_trans: get_symbol(&libs, b"bli_param_map_char_to_blis_trans\0").map(|sym| *sym),
bli_param_map_char_to_blis_conj: get_symbol(&libs, b"bli_param_map_char_to_blis_conj\0").map(|sym| *sym),
bli_param_map_char_to_blis_diag: get_symbol(&libs, b"bli_param_map_char_to_blis_diag\0").map(|sym| *sym),
bli_param_map_char_to_blis_dt: get_symbol(&libs, b"bli_param_map_char_to_blis_dt\0").map(|sym| *sym),
bli_param_map_blis_to_char_side: get_symbol(&libs, b"bli_param_map_blis_to_char_side\0").map(|sym| *sym),
bli_param_map_blis_to_char_uplo: get_symbol(&libs, b"bli_param_map_blis_to_char_uplo\0").map(|sym| *sym),
bli_param_map_blis_to_char_trans: get_symbol(&libs, b"bli_param_map_blis_to_char_trans\0").map(|sym| *sym),
bli_param_map_blis_to_char_conj: get_symbol(&libs, b"bli_param_map_blis_to_char_conj\0").map(|sym| *sym),
bli_param_map_blis_to_char_diag: get_symbol(&libs, b"bli_param_map_blis_to_char_diag\0").map(|sym| *sym),
bli_param_map_blis_to_char_dt: get_symbol(&libs, b"bli_param_map_blis_to_char_dt\0").map(|sym| *sym),
...
bli_error_checking_level: get_symbol(&libs, b"bli_error_checking_level\0").map(|sym| *sym),
bli_error_checking_level_set: get_symbol(&libs, b"bli_error_checking_level_set\0").map(|sym| *sym),
bli_error_checking_is_enabled: get_symbol(&libs, b"bli_error_checking_is_enabled\0").map(|sym| *sym),
bli_print_msg: get_symbol(&libs, b"bli_print_msg\0").map(|sym| *sym),
bli_abort: get_symbol(&libs, b"bli_abort\0").map(|sym| *sym),
bli_error_string_for_code: get_symbol(&libs, b"bli_error_string_for_code\0").map(|sym| *sym),
...
bli_cntl_attach_sub_node: get_symbol(&libs, b"bli_cntl_attach_sub_node\0").map(|sym| *sym),
...
bli_info_get_version_str: get_symbol(&libs, b"bli_info_get_version_str\0").map(|sym| *sym),
bli_info_get_int_type_size_str: get_symbol(&libs, b"bli_info_get_int_type_size_str\0").map(|sym| *sym),
bli_info_get_int_type_size: get_symbol(&libs, b"bli_info_get_int_type_size\0").map(|sym| *sym),
bli_info_get_num_fp_types: get_symbol(&libs, b"bli_info_get_num_fp_types\0").map(|sym| *sym),
bli_info_get_max_type_size: get_symbol(&libs, b"bli_info_get_max_type_size\0").map(|sym| *sym),
bli_info_get_page_size: get_symbol(&libs, b"bli_info_get_page_size\0").map(|sym| *sym),
bli_info_get_simd_num_registers: get_symbol(&libs, b"bli_info_get_simd_num_registers\0").map(|sym| *sym),
bli_info_get_simd_size: get_symbol(&libs, b"bli_info_get_simd_size\0").map(|sym| *sym),
bli_info_get_simd_align_size: get_symbol(&libs, b"bli_info_get_simd_align_size\0").map(|sym| *sym),
bli_info_get_stack_buf_max_size: get_symbol(&libs, b"bli_info_get_stack_buf_max_size\0").map(|sym| *sym),
bli_info_get_stack_buf_align_size: get_symbol(&libs, b"bli_info_get_stack_buf_align_size\0").map(|sym| *sym),
bli_info_get_heap_addr_align_size: get_symbol(&libs, b"bli_info_get_heap_addr_align_size\0").map(|sym| *sym),
bli_info_get_heap_stride_align_size: get_symbol(&libs, b"bli_info_get_heap_stride_align_size\0").map(|sym| *sym),
bli_info_get_pool_addr_align_size_a: get_symbol(&libs, b"bli_info_get_pool_addr_align_size_a\0").map(|sym| *sym),
bli_info_get_pool_addr_align_size_b: get_symbol(&libs, b"bli_info_get_pool_addr_align_size_b\0").map(|sym| *sym),
bli_info_get_pool_addr_align_size_c: get_symbol(&libs, b"bli_info_get_pool_addr_align_size_c\0").map(|sym| *sym),
bli_info_get_pool_addr_align_size_gen: get_symbol(&libs, b"bli_info_get_pool_addr_align_size_gen\0").map(|sym| *sym),
bli_info_get_pool_addr_offset_size_a: get_symbol(&libs, b"bli_info_get_pool_addr_offset_size_a\0").map(|sym| *sym),
bli_info_get_pool_addr_offset_size_b: get_symbol(&libs, b"bli_info_get_pool_addr_offset_size_b\0").map(|sym| *sym),
bli_info_get_pool_addr_offset_size_c: get_symbol(&libs, b"bli_info_get_pool_addr_offset_size_c\0").map(|sym| *sym),
bli_info_get_pool_addr_offset_size_gen: get_symbol(&libs, b"bli_info_get_pool_addr_offset_size_gen\0").map(|sym| *sym),
bli_info_get_enable_stay_auto_init: get_symbol(&libs, b"bli_info_get_enable_stay_auto_init\0").map(|sym| *sym),
bli_info_get_enable_blas: get_symbol(&libs, b"bli_info_get_enable_blas\0").map(|sym| *sym),
bli_info_get_enable_cblas: get_symbol(&libs, b"bli_info_get_enable_cblas\0").map(|sym| *sym),
bli_info_get_blas_int_type_size: get_symbol(&libs, b"bli_info_get_blas_int_type_size\0").map(|sym| *sym),
bli_info_get_enable_pba_pools: get_symbol(&libs, b"bli_info_get_enable_pba_pools\0").map(|sym| *sym),
bli_info_get_enable_sba_pools: get_symbol(&libs, b"bli_info_get_enable_sba_pools\0").map(|sym| *sym),
bli_info_get_enable_threading: get_symbol(&libs, b"bli_info_get_enable_threading\0").map(|sym| *sym),
bli_info_get_enable_openmp: get_symbol(&libs, b"bli_info_get_enable_openmp\0").map(|sym| *sym),
bli_info_get_enable_pthreads: get_symbol(&libs, b"bli_info_get_enable_pthreads\0").map(|sym| *sym),
bli_info_get_enable_hpx: get_symbol(&libs, b"bli_info_get_enable_hpx\0").map(|sym| *sym),
bli_info_get_enable_openmp_as_default: get_symbol(&libs, b"bli_info_get_enable_openmp_as_default\0").map(|sym| *sym),
bli_info_get_enable_pthreads_as_default: get_symbol(&libs, b"bli_info_get_enable_pthreads_as_default\0").map(|sym| *sym),
bli_info_get_enable_hpx_as_default: get_symbol(&libs, b"bli_info_get_enable_hpx_as_default\0").map(|sym| *sym),
bli_info_get_thread_jrir_slab: get_symbol(&libs, b"bli_info_get_thread_jrir_slab\0").map(|sym| *sym),
bli_info_get_thread_jrir_rr: get_symbol(&libs, b"bli_info_get_thread_jrir_rr\0").map(|sym| *sym),
bli_info_get_thread_jrir_tlb: get_symbol(&libs, b"bli_info_get_thread_jrir_tlb\0").map(|sym| *sym),
bli_info_get_enable_tls: get_symbol(&libs, b"bli_info_get_enable_tls\0").map(|sym| *sym),
bli_info_get_enable_memkind: get_symbol(&libs, b"bli_info_get_enable_memkind\0").map(|sym| *sym),
bli_info_get_enable_sandbox: get_symbol(&libs, b"bli_info_get_enable_sandbox\0").map(|sym| *sym),
bli_info_get_gemm_ukr_impl_string: get_symbol(&libs, b"bli_info_get_gemm_ukr_impl_string\0").map(|sym| *sym),
bli_info_get_gemmtrsm_l_ukr_impl_string: get_symbol(&libs, b"bli_info_get_gemmtrsm_l_ukr_impl_string\0").map(|sym| *sym),
bli_info_get_gemmtrsm_u_ukr_impl_string: get_symbol(&libs, b"bli_info_get_gemmtrsm_u_ukr_impl_string\0").map(|sym| *sym),
bli_info_get_trsm_l_ukr_impl_string: get_symbol(&libs, b"bli_info_get_trsm_l_ukr_impl_string\0").map(|sym| *sym),
bli_info_get_trsm_u_ukr_impl_string: get_symbol(&libs, b"bli_info_get_trsm_u_ukr_impl_string\0").map(|sym| *sym),
bli_info_get_gemm_impl_string: get_symbol(&libs, b"bli_info_get_gemm_impl_string\0").map(|sym| *sym),
bli_info_get_gemmt_impl_string: get_symbol(&libs, b"bli_info_get_gemmt_impl_string\0").map(|sym| *sym),
bli_info_get_hemm_impl_string: get_symbol(&libs, b"bli_info_get_hemm_impl_string\0").map(|sym| *sym),
bli_info_get_herk_impl_string: get_symbol(&libs, b"bli_info_get_herk_impl_string\0").map(|sym| *sym),
bli_info_get_her2k_impl_string: get_symbol(&libs, b"bli_info_get_her2k_impl_string\0").map(|sym| *sym),
bli_info_get_symm_impl_string: get_symbol(&libs, b"bli_info_get_symm_impl_string\0").map(|sym| *sym),
bli_info_get_syrk_impl_string: get_symbol(&libs, b"bli_info_get_syrk_impl_string\0").map(|sym| *sym),
bli_info_get_syr2k_impl_string: get_symbol(&libs, b"bli_info_get_syr2k_impl_string\0").map(|sym| *sym),
bli_info_get_trmm_impl_string: get_symbol(&libs, b"bli_info_get_trmm_impl_string\0").map(|sym| *sym),
bli_info_get_trmm3_impl_string: get_symbol(&libs, b"bli_info_get_trmm3_impl_string\0").map(|sym| *sym),
bli_info_get_trsm_impl_string: get_symbol(&libs, b"bli_info_get_trsm_impl_string\0").map(|sym| *sym),
...
bli_cpuid_is_sandybridge: get_symbol(&libs, b"bli_cpuid_is_sandybridge\0").map(|sym| *sym),
...
bli_cpuid_is_steamroller: get_symbol(&libs, b"bli_cpuid_is_steamroller\0").map(|sym| *sym),
bli_cpuid_is_piledriver: get_symbol(&libs, b"bli_cpuid_is_piledriver\0").map(|sym| *sym),
...
bli_ssxpbym_md_unb_var1: get_symbol(&libs, b"bli_ssxpbym_md_unb_var1\0").map(|sym| *sym),
bli_ddxpbym_md_unb_var1: get_symbol(&libs, b"bli_ddxpbym_md_unb_var1\0").map(|sym| *sym),
bli_ccxpbym_md_unb_var1: get_symbol(&libs, b"bli_ccxpbym_md_unb_var1\0").map(|sym| *sym),
bli_zzxpbym_md_unb_var1: get_symbol(&libs, b"bli_zzxpbym_md_unb_var1\0").map(|sym| *sym),
bli_sdxpbym_md_unb_var1: get_symbol(&libs, b"bli_sdxpbym_md_unb_var1\0").map(|sym| *sym),
bli_scxpbym_md_unb_var1: get_symbol(&libs, b"bli_scxpbym_md_unb_var1\0").map(|sym| *sym),
bli_szxpbym_md_unb_var1: get_symbol(&libs, b"bli_szxpbym_md_unb_var1\0").map(|sym| *sym),
bli_dsxpbym_md_unb_var1: get_symbol(&libs, b"bli_dsxpbym_md_unb_var1\0").map(|sym| *sym),
bli_dcxpbym_md_unb_var1: get_symbol(&libs, b"bli_dcxpbym_md_unb_var1\0").map(|sym| *sym),
bli_dzxpbym_md_unb_var1: get_symbol(&libs, b"bli_dzxpbym_md_unb_var1\0").map(|sym| *sym),
bli_csxpbym_md_unb_var1: get_symbol(&libs, b"bli_csxpbym_md_unb_var1\0").map(|sym| *sym),
bli_cdxpbym_md_unb_var1: get_symbol(&libs, b"bli_cdxpbym_md_unb_var1\0").map(|sym| *sym),
bli_czxpbym_md_unb_var1: get_symbol(&libs, b"bli_czxpbym_md_unb_var1\0").map(|sym| *sym),
bli_zsxpbym_md_unb_var1: get_symbol(&libs, b"bli_zsxpbym_md_unb_var1\0").map(|sym| *sym),
bli_zdxpbym_md_unb_var1: get_symbol(&libs, b"bli_zdxpbym_md_unb_var1\0").map(|sym| *sym),
bli_zcxpbym_md_unb_var1: get_symbol(&libs, b"bli_zcxpbym_md_unb_var1\0").map(|sym| *sym),
...
bli_packm_cntl_init_node: get_symbol(&libs, b"bli_packm_cntl_init_node\0").map(|sym| *sym),
bli_packm_def_cntl_init_node: get_symbol(&libs, b"bli_packm_def_cntl_init_node\0").map(|sym| *sym),
...
bli_unpackm_cntl_init_node: get_symbol(&libs, b"bli_unpackm_cntl_init_node\0").map(|sym| *sym),
...
bli_l3_return_early_if_trivial: get_symbol(&libs, b"bli_l3_return_early_if_trivial\0").map(|sym| *sym),
...
bli_l3_sup_thrinfo_create: get_symbol(&libs, b"bli_l3_sup_thrinfo_create\0").map(|sym| *sym),
bli_l3_sup_thrinfo_update: get_symbol(&libs, b"bli_l3_sup_thrinfo_update\0").map(|sym| *sym),
bli_l3_thrinfo_print_gemm_paths: get_symbol(&libs, b"bli_l3_thrinfo_print_gemm_paths\0").map(|sym| *sym),
bli_l3_thrinfo_print_trsm_paths: get_symbol(&libs, b"bli_l3_thrinfo_print_trsm_paths\0").map(|sym| *sym),
bli_l3_thrinfo_free_paths: get_symbol(&libs, b"bli_l3_thrinfo_free_paths\0").map(|sym| *sym),
bli_l3_thread_decorator: get_symbol(&libs, b"bli_l3_thread_decorator\0").map(|sym| *sym),
bli_l3_thread_decorator_check: get_symbol(&libs, b"bli_l3_thread_decorator_check\0").map(|sym| *sym),
bli_l3_thread_decorator_thread_check: get_symbol(&libs, b"bli_l3_thread_decorator_thread_check\0").map(|sym| *sym),
bli_l3_sup_thread_decorator: get_symbol(&libs, b"bli_l3_sup_thread_decorator\0").map(|sym| *sym),
...
bli_l3_prune_unref_mparts_m: get_symbol(&libs, b"bli_l3_prune_unref_mparts_m\0").map(|sym| *sym),
bli_l3_prune_unref_mparts_n: get_symbol(&libs, b"bli_l3_prune_unref_mparts_n\0").map(|sym| *sym),
bli_l3_prune_unref_mparts_k: get_symbol(&libs, b"bli_l3_prune_unref_mparts_k\0").map(|sym| *sym),
...
bli_packm_sup_finalize_mem: get_symbol(&libs, b"bli_packm_sup_finalize_mem\0").map(|sym| *sym),
...
bli_sgemmtrsm_l_ukernel: get_symbol(&libs, b"bli_sgemmtrsm_l_ukernel\0").map(|sym| *sym),
bli_dgemmtrsm_l_ukernel: get_symbol(&libs, b"bli_dgemmtrsm_l_ukernel\0").map(|sym| *sym),
bli_cgemmtrsm_l_ukernel: get_symbol(&libs, b"bli_cgemmtrsm_l_ukernel\0").map(|sym| *sym),
bli_zgemmtrsm_l_ukernel: get_symbol(&libs, b"bli_zgemmtrsm_l_ukernel\0").map(|sym| *sym),
bli_sgemmtrsm_u_ukernel: get_symbol(&libs, b"bli_sgemmtrsm_u_ukernel\0").map(|sym| *sym),
bli_dgemmtrsm_u_ukernel: get_symbol(&libs, b"bli_dgemmtrsm_u_ukernel\0").map(|sym| *sym),
bli_cgemmtrsm_u_ukernel: get_symbol(&libs, b"bli_cgemmtrsm_u_ukernel\0").map(|sym| *sym),
bli_zgemmtrsm_u_ukernel: get_symbol(&libs, b"bli_zgemmtrsm_u_ukernel\0").map(|sym| *sym),
...
bli_gemmtrsm_l_ukernel_qfp: get_symbol(&libs, b"bli_gemmtrsm_l_ukernel_qfp\0").map(|sym| *sym),
bli_gemmtrsm_u_ukernel_qfp: get_symbol(&libs, b"bli_gemmtrsm_u_ukernel_qfp\0").map(|sym| *sym),
...
bli_gemm_var_cntl_init_node: get_symbol(&libs, b"bli_gemm_var_cntl_init_node\0").map(|sym| *sym),
...
bli_trsm_var_cntl_init_node: get_symbol(&libs, b"bli_trsm_var_cntl_init_node\0").map(|sym| *sym),
...
bli_thread_set_num_threads_: get_symbol(&libs, b"bli_thread_set_num_threads_\0").map(|sym| *sym),
