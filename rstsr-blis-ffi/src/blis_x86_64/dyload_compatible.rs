...
pub unsafe fn bli_pthread_switch_on(
...
pub unsafe fn bli_pthread_switch_off(
    sw: *mut bli_pthread_switch_t,
...
pub unsafe fn bli_sgemm_skx_asm_32x12_l2(
    ...
    dyload_lib().bli_sgemm_skx_asm_32x12_l2.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_dgemm_skx_asm_16x14(
    ...
    dyload_lib().bli_dgemm_skx_asm_16x14.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_sgemm_knl_asm_24x16(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_sgemm_knl_asm_24x16.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemm_knl_asm_24x8(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_knl_asm_24x8.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_spackm_knl_asm_24x16(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_spackm_knl_asm_24x16.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_dpackm_knl_asm_24x8(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_dpackm_knl_asm_24x8.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_dgemm_knl_asm_12x16(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_knl_asm_12x16.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemm_knl_asm_30x8(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_knl_asm_30x8.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemm_knl_asm_8x24(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_knl_asm_8x24.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dpackm_knl_asm_30x8(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_dpackm_knl_asm_30x8.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_spackm_haswell_asm_6x16(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_spackm_haswell_asm_6x16.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_dpackm_haswell_asm_6x8(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_dpackm_haswell_asm_6x8.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_cpackm_haswell_asm_3x8(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_cpackm_haswell_asm_3x8.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_zpackm_haswell_asm_3x4(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_zpackm_haswell_asm_3x4.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}
...
pub unsafe fn bli_dgemm_haswell_asm_6x8(
    ...
    dyload_lib().bli_dgemm_haswell_asm_6x8.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_cgemm_haswell_asm_3x8(
    ...
    dyload_lib().bli_cgemm_haswell_asm_3x8.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_zgemm_haswell_asm_3x4(
    ...
    dyload_lib().bli_zgemm_haswell_asm_3x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_dgemm_haswell_asm_8x6(
    ...
    dyload_lib().bli_dgemm_haswell_asm_8x6.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_cgemm_haswell_asm_8x3(
    ...
    dyload_lib().bli_cgemm_haswell_asm_8x3.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_zgemm_haswell_asm_4x3(
    ...
    dyload_lib().bli_zgemm_haswell_asm_4x3.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_sgemmtrsm_l_haswell_asm_6x16(
    ...
    dyload_lib().bli_sgemmtrsm_l_haswell_asm_6x16.unwrap()(
        m, n, k, alpha, a1x, a11, bx1, b11, c11, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_sgemm_sandybridge_asm_8x8(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_sgemm_sandybridge_asm_8x8.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemm_sandybridge_asm_8x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_sandybridge_asm_8x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_cgemm_sandybridge_asm_8x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_cgemm_sandybridge_asm_8x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_zgemm_sandybridge_asm_4x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_zgemm_sandybridge_asm_4x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_sgemm_sandybridge_int_8x8(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_sgemm_sandybridge_int_8x8.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemm_sandybridge_int_8x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_sandybridge_int_8x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_cgemm_sandybridge_int_8x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_cgemm_sandybridge_int_8x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_zgemm_sandybridge_int_4x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_zgemm_sandybridge_int_4x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_sgemm_penryn_asm_8x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_sgemm_penryn_asm_8x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemm_penryn_asm_4x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_penryn_asm_4x4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemmtrsm_l_penryn_asm_4x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemmtrsm_l_penryn_asm_4x4.unwrap()(
        m, n, k, alpha, a1x, a11, bx1, b11, c11, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemmtrsm_u_penryn_asm_4x4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemmtrsm_u_penryn_asm_4x4.unwrap()(
        m, n, k, alpha, a1x, a11, bx1, b11, c11, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dtrsm_l_penryn_asm_4x4(
    a: *const c_void,
    b: *mut c_void,
    c: *mut c_void,
    rs_c: inc_t,
...
pub unsafe fn bli_dtrsm_u_penryn_asm_4x4(
    a: *const c_void,
    b: *mut c_void,
    c: *mut c_void,
    rs_c: inc_t,
...
pub unsafe fn bli_dpackm_8xk_gen_zen(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_dpackm_8xk_gen_zen.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_dpackm_6xk_gen_zen(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_dpackm_6xk_gen_zen.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_dpackm_8xk_nn_zen(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_dpackm_8xk_nn_zen.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}

pub unsafe fn bli_dpackm_6xk_nn_zen(
    conja: conj_t,
    schema: pack_t,
    cdim: dim_t,
    cdim_max: dim_t,
    ...
    dyload_lib().bli_dpackm_6xk_nn_zen.unwrap()(
        conja, schema, cdim, cdim_max, cdim_bcast, n, n_max, kappa, a, inca, lda, p, ldp, params,
        cntx,
    )
}
...
pub unsafe fn bli_cscalv_zen_int10(
    conjalpha: conj_t,
    n: dim_t,
    alpha: *const c_void,
    x: *mut c_void,
...
pub unsafe fn bli_sgemm_piledriver_asm_16x3(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_sgemm_piledriver_asm_16x3.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemm_piledriver_asm_8x3(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_piledriver_asm_8x3.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_cgemm_piledriver_asm_4x2(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_cgemm_piledriver_asm_4x2.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_zgemm_piledriver_asm_2x2(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_zgemm_piledriver_asm_2x2.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_sgemm_bulldozer_asm_8x8_fma4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_sgemm_bulldozer_asm_8x8_fma4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_dgemm_bulldozer_asm_4x6_fma4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_dgemm_bulldozer_asm_4x6_fma4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_cgemm_bulldozer_asm_8x4_fma4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_cgemm_bulldozer_asm_8x4_fma4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}

pub unsafe fn bli_zgemm_bulldozer_asm_4x4_fma4(
    m: dim_t,
    n: dim_t,
    k: dim_t,
    alpha: *const c_void,
    ...
    dyload_lib().bli_zgemm_bulldozer_asm_4x4_fma4.unwrap()(
        m, n, k, alpha, a, b, beta, c, rs_c, cs_c, data, cntx,
    )
}
...
pub unsafe fn bli_thrcomm_create(
    ti: timpl_t,
    sba_pool: *mut pool_t,
    n_threads: dim_t,
) -> *mut thrcomm_t {
...
pub unsafe fn bli_thrinfo_create_root(
    comm: *mut thrcomm_t,
    thread_id: dim_t,
    sba_pool: *mut pool_t,
    pba: *mut pba_t,
...
pub unsafe fn bli_thrinfo_create(
    ...
    dyload_lib().bli_thrinfo_create.unwrap()(
        comm, thread_id, n_way, work_id, free_comm, sba_pool, pba,
    )
}
...
pub unsafe fn bli_thread_launch(
    ti: timpl_t,
    nt: dim_t,
    func: thread_func_t,
    params: *const c_void,
...
pub unsafe fn bli_thread_range_mdim(
    ...
    dyload_lib().bli_thread_range_mdim.unwrap()(
        direct,
        bmult,
        use_weighted,
        thr,
...
pub unsafe fn bli_thread_range_ndim(
    ...
    dyload_lib().bli_thread_range_ndim.unwrap()(
        direct,
        bmult,
        use_weighted,
        thr,
...
pub unsafe fn bli_thread_range(
    thr: *const thrinfo_t,
    a: *const obj_t,
    bf: dim_t,
    direct: dir_t,
...
pub unsafe fn bli_thread_range_quad(
    thread: *const thrinfo_t,
    diagoff: doff_t,
    uplo: uplo_t,
    m: dim_t,
    ...
    dyload_lib().bli_thread_range_quad.unwrap()(
        thread,
        diagoff,
        uplo,
        m,
...
pub unsafe fn bli_thread_range_tlb_l(
    nt: dim_t,
    tid: dim_t,
    diagoff: doff_t,
    m_iter: dim_t,
    ...
    dyload_lib().bli_thread_range_tlb_l.unwrap()(
        nt, tid, diagoff, m_iter, n_iter, mr, nr, j_st_p, i_st_p,
    )
}

pub unsafe fn bli_thread_range_tlb_u(
    nt: dim_t,
    tid: dim_t,
    diagoff: doff_t,
    m_iter: dim_t,
    ...
    dyload_lib().bli_thread_range_tlb_u.unwrap()(
        nt, tid, diagoff, m_iter, n_iter, mr, nr, j_st_p, i_st_p,
    )
}

pub unsafe fn bli_thread_range_tlb_d(
    nt: dim_t,
    tid: dim_t,
    m_iter: dim_t,
    n_iter: dim_t,
...
pub unsafe fn bli_thread_range_tlb_trmm_ll(
    nt: dim_t,
    tid: dim_t,
    diagoff: doff_t,
    m_iter: dim_t,
    ...
    dyload_lib().bli_thread_range_tlb_trmm_ll.unwrap()(
        nt, tid, diagoff, m_iter, n_iter, k_iter, mr, nr, j_st_p, i_st_p,
    )
}

pub unsafe fn bli_thread_range_tlb_trmm_lu(
    nt: dim_t,
    tid: dim_t,
    diagoff: doff_t,
    m_iter: dim_t,
    ...
    dyload_lib().bli_thread_range_tlb_trmm_lu.unwrap()(
        nt, tid, diagoff, m_iter, n_iter, k_iter, mr, nr, j_st_p, i_st_p,
    )
}

pub unsafe fn bli_thread_range_tlb_trmm_lx_impl(
    nt: dim_t,
    tid: dim_t,
    diagoff: doff_t,
    uplo: uplo_t,
    ...
    dyload_lib().bli_thread_range_tlb_trmm_lx_impl.unwrap()(
        nt, tid, diagoff, uplo, m_iter, n_iter, k_iter, mr, nr, j_st_p, i_st_p,
    )
}

pub unsafe fn bli_thread_range_tlb_trmm_rl(
    nt: dim_t,
    tid: dim_t,
    diagoff: doff_t,
    m_iter: dim_t,
    ...
    dyload_lib().bli_thread_range_tlb_trmm_rl.unwrap()(
        nt, tid, diagoff, m_iter, n_iter, k_iter, mr, nr, j_st_p, i_st_p,
    )
}

pub unsafe fn bli_thread_range_tlb_trmm_ru(
    nt: dim_t,
    tid: dim_t,
    diagoff: doff_t,
    m_iter: dim_t,
    ...
    dyload_lib().bli_thread_range_tlb_trmm_ru.unwrap()(
        nt, tid, diagoff, m_iter, n_iter, k_iter, mr, nr, j_st_p, i_st_p,
    )
}

pub unsafe fn bli_thread_range_tlb_trmm_rl_impl(
    nt: dim_t,
    tid: dim_t,
    diagoff: doff_t,
    m_iter: dim_t,
    ...
    dyload_lib().bli_thread_range_tlb_trmm_rl_impl.unwrap()(
        nt, tid, diagoff, m_iter, n_iter, k_iter, mr, nr, j_st_p, i_st_p, j_en_p, i_en_p,
    )
}
...
pub unsafe fn bli_obj_create_without_buffer_check(
    dt: num_t,
    m: dim_t,
    n: dim_t,
    obj: *const obj_t,
...
pub unsafe fn bli_func2_create(
    ptr_ss: void_fp,
    ptr_sd: void_fp,
    ptr_sc: void_fp,
    ptr_sz: void_fp,
    ...
    dyload_lib().bli_func2_create.unwrap()(
        ptr_ss, ptr_sd, ptr_sc, ptr_sz, ptr_ds, ptr_dd, ptr_dc, ptr_dz, ptr_cs, ptr_cd, ptr_cc,
        ptr_cz, ptr_zs, ptr_zd, ptr_zc, ptr_zz,
    )
}

pub unsafe fn bli_func2_init(
    f: *mut func2_t,
    ptr_ss: void_fp,
    ptr_sd: void_fp,
    ptr_sc: void_fp,
    ...
    dyload_lib().bli_func2_init.unwrap()(
        f, ptr_ss, ptr_sd, ptr_sc, ptr_sz, ptr_ds, ptr_dd, ptr_dc, ptr_dz, ptr_cs, ptr_cd, ptr_cc,
        ptr_cz, ptr_zs, ptr_zd, ptr_zc, ptr_zz,
    )
}
...
pub unsafe fn bli_check_error_code_helper(
    code: gint_t,
    file: *const c_char,
    line: guint_t,
) -> err_t {
...
pub unsafe fn bli_cntx_register_blksz(
    bs_id: *mut kerid_t,
    blksz: *const blksz_t,
    bmult_id: kerid_t,
    cntx: *mut cntx_t,
...
pub unsafe fn bli_cntx_register_ukr(
    ukr_id: *mut kerid_t,
    ukr: *const func_t,
    cntx: *mut cntx_t,
) -> err_t {
...
pub unsafe fn bli_cntx_register_ukr2(
    ukr_id: *mut kerid_t,
    ukr: *const func2_t,
    cntx: *mut cntx_t,
) -> err_t {
...
pub unsafe fn bli_cntx_register_ukr_pref(
...
pub unsafe fn bli_rntm_set_ways(
    jc: dim_t,
    pc: dim_t,
    ic: dim_t,
    jr: dim_t,
...
pub unsafe fn bli_rntm_calc_num_threads_in(
    bszid_cur: *const bszid_t,
    rntm: *const rntm_t,
) -> dim_t {
...
pub unsafe fn bli_gks_cntx_ukr2_is_ref(
    dt1: num_t,
    dt2: num_t,
    ukr_id: ukr_t,
    cntx: *const cntx_t,
...
pub unsafe fn bli_part_cntl_init_node(
    var_func: void_fp,
    b_dt: num_t,
    b_alg: dim_t,
    b_max: dim_t,
    ...
    dyload_lib().bli_part_cntl_init_node.unwrap()(
        var_func,
        b_dt,
        b_alg,
        b_max,
...
pub unsafe fn bli_axpbyv_check(
    alpha: *const obj_t,
    x: *const obj_t,
    beta: *const obj_t,
    y: *const obj_t,
...
pub unsafe fn bli_sinvscalv_ex(
    conjalpha: conj_t,
    n: dim_t,
    alpha: *const f32,
    x: *mut f32,
...
pub unsafe fn bli_dinvscalv_ex(
    conjalpha: conj_t,
    n: dim_t,
    alpha: *const f64,
    x: *mut f64,
...
pub unsafe fn bli_cinvscalv_ex(
    conjalpha: conj_t,
    n: dim_t,
    alpha: *const scomplex,
    x: *mut scomplex,
...
pub unsafe fn bli_zinvscalv_ex(
    conjalpha: conj_t,
    n: dim_t,
    alpha: *const dcomplex,
    x: *mut dcomplex,
...
pub unsafe fn bli_sinvscald_ex(
    conjalpha: conj_t,
    diagoffx: doff_t,
    m: dim_t,
    n: dim_t,
    ...
    dyload_lib().bli_sinvscald_ex.unwrap()(
        conjalpha, diagoffx, m, n, alpha, x, rs_x, cs_x, cntx, rntm,
    )
}

pub unsafe fn bli_dinvscald_ex(
    conjalpha: conj_t,
    diagoffx: doff_t,
    m: dim_t,
    n: dim_t,
    ...
    dyload_lib().bli_dinvscald_ex.unwrap()(
        conjalpha, diagoffx, m, n, alpha, x, rs_x, cs_x, cntx, rntm,
    )
}

pub unsafe fn bli_cinvscald_ex(
    conjalpha: conj_t,
    diagoffx: doff_t,
    m: dim_t,
    n: dim_t,
    ...
    dyload_lib().bli_cinvscald_ex.unwrap()(
        conjalpha, diagoffx, m, n, alpha, x, rs_x, cs_x, cntx, rntm,
    )
}

pub unsafe fn bli_zinvscald_ex(
    conjalpha: conj_t,
    diagoffx: doff_t,
    m: dim_t,
    n: dim_t,
    ...
    dyload_lib().bli_zinvscald_ex.unwrap()(
        conjalpha, diagoffx, m, n, alpha, x, rs_x, cs_x, cntx, rntm,
    )
}
...
pub unsafe fn bli_sinvscalm_ex(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_sinvscalm_ex.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x, cntx, rntm,
    )
}

pub unsafe fn bli_dinvscalm_ex(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_dinvscalm_ex.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x, cntx, rntm,
    )
}

pub unsafe fn bli_cinvscalm_ex(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_cinvscalm_ex.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x, cntx, rntm,
    )
}

pub unsafe fn bli_zinvscalm_ex(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_zinvscalm_ex.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x, cntx, rntm,
    )
}
...
pub unsafe fn bli_sinvscalm(
    ...
    dyload_lib().bli_sinvscalm.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x,
    )
}

pub unsafe fn bli_dinvscalm(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_dinvscalm.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x,
    )
}

pub unsafe fn bli_cinvscalm(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_cinvscalm.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x,
    )
}

pub unsafe fn bli_zinvscalm(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_zinvscalm.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x,
    )
}
...
pub unsafe fn bli_saddm_unb_var1(
    ...
    dyload_lib().bli_saddm_unb_var1.unwrap()(
        diagoffx, diagx, uplox, transx, m, n, x, rs_x, cs_x, y, rs_y, cs_y, cntx,
    )
}
...
pub unsafe fn bli_saxpym_unb_var1(
    ...
    dyload_lib().bli_saxpym_unb_var1.unwrap()(
        diagoffx, diagx, uplox, transx, m, n, alpha, x, rs_x, cs_x, y, rs_y, cs_y, cntx,
    )
}
...
pub unsafe fn bli_sinvscalm_unb_var1(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_sinvscalm_unb_var1.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x, cntx,
    )
}

pub unsafe fn bli_dinvscalm_unb_var1(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_dinvscalm_unb_var1.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x, cntx,
    )
}

pub unsafe fn bli_cinvscalm_unb_var1(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_cinvscalm_unb_var1.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x, cntx,
    )
}

pub unsafe fn bli_zinvscalm_unb_var1(
    conjalpha: conj_t,
    diagoffx: doff_t,
    diagx: diag_t,
    uplox: uplo_t,
    ...
    dyload_lib().bli_zinvscalm_unb_var1.unwrap()(
        conjalpha, diagoffx, diagx, uplox, m, n, alpha, x, rs_x, cs_x, cntx,
    )
}
...
pub unsafe fn bli_sxpbym_unb_var1(
    ...
    dyload_lib().bli_sxpbym_unb_var1.unwrap()(
        diagoffx, diagx, uplox, transx, m, n, x, rs_x, cs_x, beta, y, rs_y, cs_y, cntx,
    )
}
...
pub unsafe fn bli_packm_alloc_ex(
    size_needed: siz_t,
...
pub unsafe fn bli_packm_cntl_init_node(
    var_func: void_fp,
    var: packm_var_oft,
    params: *const c_void,
...
pub unsafe fn bli_packm_def_cntl_init_node(
    var_func: void_fp,
    dt_orig: num_t,
    dt_pack: num_t,
    dt_bmult: num_t,
    ...
    dyload_lib().bli_packm_def_cntl_init_node.unwrap()(
        var_func,
        dt_orig,
        dt_pack,
        dt_bmult,
...
pub unsafe fn bli_sspackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_sspackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_ddpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_ddpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_ccpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_ccpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_zzpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_zzpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_sdpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_sdpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_szpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_szpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_dspackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_dspackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_dcpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_dcpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_cdpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_cdpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_czpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_czpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_zspackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_zspackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_zcpackm_struc_cxk(
    strucc: struc_t,
    diagc: diag_t,
    uploc: uplo_t,
    conjc: conj_t,
    ...
    dyload_lib().bli_zcpackm_struc_cxk.unwrap()(
        strucc,
        diagc,
        uploc,
        conjc,
...
pub unsafe fn bli_unpackm_cntl_init_node(
    var_func: void_fp,
...
pub unsafe fn bli_l3_return_early_if_trivial(
    alpha: *const obj_t,
    a: *const obj_t,
    b: *const obj_t,
    beta: *const obj_t,
...
pub unsafe fn bli_l3_thrinfo_create(
    id: dim_t,
...
pub unsafe fn bli_l3_thrinfo_grow(
    thread: *mut thrinfo_t,
    rntm: *const rntm_t,
    cntl: *const cntl_t,
) {
...
pub unsafe fn bli_l3_sup_thrinfo_create(
    id: dim_t,
    gl_comm: *mut thrcomm_t,
    pool: *mut pool_t,
    rntm: *const rntm_t,
...
pub unsafe fn bli_trsm_basic_check(
    side: side_t,
    alpha: *const obj_t,
    a: *const obj_t,
    b: *const obj_t,
...
pub unsafe fn bli_packm_sup(
    ...
    dyload_lib().bli_packm_sup.unwrap()(
        will_pack,
        pack_buf_type,
        stor_id,
        dt,
...
pub unsafe fn bli_gemm_var_cntl_init_node(
    var_func: void_fp,
    dt_comp: num_t,
    dt_out: num_t,
    ukr: gemm_ukr_ft,
    ...
    dyload_lib().bli_gemm_var_cntl_init_node.unwrap()(
        var_func, dt_comp, dt_out, ukr, real_ukr, row_pref, mr, nr, mr_scale, nr_scale, cntl,
    )
}

pub unsafe fn bli_gemm_cntl_init(
    im: ind_t,
    family: opid_t,
    alpha: *const obj_t,
    a: *mut obj_t,
...
pub unsafe fn bli_gemm_cntl_finalize(
    family: opid_t,
    a: *const obj_t,
    b: *const obj_t,
    c: *const obj_t,
...
pub unsafe fn bli_trmm_ll_ker_var2b(
    a: *const obj_t,
    b: *const obj_t,
    c: *const obj_t,
    cntx: *const cntx_t,
...
pub unsafe fn bli_trmm_lu_ker_var2b(
    a: *const obj_t,
    b: *const obj_t,
    c: *const obj_t,
    cntx: *const cntx_t,
...
pub unsafe fn bli_trmm_rl_ker_var2b(
    a: *const obj_t,
    b: *const obj_t,
    c: *const obj_t,
    cntx: *const cntx_t,
...
pub unsafe fn bli_trmm_ru_ker_var2b(
    a: *const obj_t,
    b: *const obj_t,
    c: *const obj_t,
    cntx: *const cntx_t,
...
pub unsafe fn bli_trsm_var_cntl_init_node(
    var_func: void_fp,
    dt_comp: num_t,
    dt_out: num_t,
    ...
    dyload_lib().bli_trsm_var_cntl_init_node.unwrap()(
        var_func,
        dt_comp,
        dt_out,
        gemmtrsm_ukr,
...
pub unsafe fn bli_trsm_cntl_init(
    im: ind_t,
    alpha: *const obj_t,
    a: *mut obj_t,
    b: *mut obj_t,
...
pub unsafe fn bli_trsm_l_cntl_init(
    im: ind_t,
    alpha: *const obj_t,
    a: *mut obj_t,
    b: *mut obj_t,
...
pub unsafe fn bli_trsm_r_cntl_init(
    im: ind_t,
    alpha: *const obj_t,
    a: *mut obj_t,
    b: *mut obj_t,
...
pub unsafe fn bli_gemmt_l_ker_var2(
    a: *const obj_t,
    ah: *const obj_t,
    c: *const obj_t,
    cntx: *const cntx_t,
...
pub unsafe fn bli_gemmt_u_ker_var2(
    a: *const obj_t,
    ah: *const obj_t,
    c: *const obj_t,
    cntx: *const cntx_t,
...
pub unsafe fn bli_gemmt_l_ker_var2b(
    a: *const obj_t,
    ah: *const obj_t,
    c: *const obj_t,
    cntx: *const cntx_t,
...
pub unsafe fn bli_gemmt_u_ker_var2b(
    a: *const obj_t,
    ah: *const obj_t,
    c: *const obj_t,
    cntx: *const cntx_t,
